...
class SubMessage(object):
    ...
    def build_transpose_dict(self, vowels_permutation):
        ...
        Creates a dictionary that can be used to apply a cipher_dict to a letter.
        ...
        for i in range(len(vowels_permutation)):
            ...
            cipher_dict[VOWELS_UPPER[i]] = vowels_permutation[i]
...
class EncryptedSubMessage(SubMessage):
    ...
    def decrypt_message(self):
        ...
        for p in permutations:
            decryption_attempt = self.apply_transpose(self.build_transpose_dict(p))
            decrypted = decryption_attempt.split(" ")
            i = 0
            for word in decrypted:
                if is_word(self.valid_words, word):
                    i += 1
            if i > most_word_count:
                most_word_count += i
