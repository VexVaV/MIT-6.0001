...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        for i in range(len(upper_letters)):
            mappedLetters[lower_letters[i] ] = lower_letters[(i + shift) % 26]
            mappedLetters[upper_letters[i] ] = upper_letters[(i + shift) % 26]
    ...
    def apply_shift(self, shift):
        ...
        '''
        ceasarShifted = self.build_shift_dict(shift)
        shifted_message = ""
        message = self.message_text
        for character in message:
            if character.isalpha():
                shifted_message += ceasarShifted[character]
            else:
...
class PlaintextMessage(Message):
    ...
    def change_shift(self, shift):
        ...
        Returns: nothing
        '''
        self.__init__(self, self.get_message_text(), shift)
